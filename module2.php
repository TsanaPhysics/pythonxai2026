...
<header class="page-header">
    <div class="container">
        <h1>บทที่ 2: Predictive Intelligence</h1>
        <p>ดิน ปุ๋ย และอนาคต สอนให้หุ่นยนต์พยากรณ์ผลผลิตจากข้อมูลมหาศาล</p>
    </div>
</header>
...
<main class="container">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start; margin-bottom: 60px;">
        <div class="card">
            <div class="card-img" style="height: 400px;"><img src="assets/images/module2_ml_xai.png" alt="Module Image"></div>
        </div>
        <div>
            <h2 style="color: var(--secondary); margin-bottom: 20px;">เรียนรู้นวัตกรรมบทที่ 2</h2>
            ...
            <div style="margin-top: 30px;">
                <a href="#code-gallery" class="btn" style="width:100%;">เลื่อนไปดูรหัสคำสั่ง 2 ทั้งหมด</a>
            </div>
        </div>
    </div>
    ...
    <div id="code-gallery" style="margin-top: 80px;">
        ...
        <div class="accordion">
            <?php
            $ch_padded = str_pad(2, 2, '0', STR_PAD_LEFT);
    ...
    <div style="margin-top: 60px; padding: 40px; background: var(--bg-light); border: 2px dashed var(--primary); border-radius: 20px;">
        ...
        <div style="display: flex; gap: 20px;">
            ...
            <a href="module3.php" class="btn">ไปที่บทเรียนถัดไป &raquo;</a>
        </div>
    </div>
</main>
...
<script>
    ...
    document.querySelectorAll('.nav-links a').forEach(a => {
        if(a.innerText.includes('บทที่ 2')) a.classList.add('active');
    });
</script>
