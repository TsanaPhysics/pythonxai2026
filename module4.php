...
<header class="page-header">
    <div class="container">
        <h1>บทที่ 4: Digital Eyes & Liaison</h1>
        <p>ดวงตาอัจฉริยะและการสื่อสาร ประมวลผลวิดีโอและวิเคราะห์ความรู้สึก</p>
    </div>
</header>
...
<main class="container">
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start; margin-bottom: 60px;">
        <div class="card">
            <div class="card-img" style="height: 400px;"><img src="assets/images/module5_cv.png" alt="Module Image"></div>
        </div>
        <div>
            <h2 style="color: var(--secondary); margin-bottom: 20px;">เรียนรู้นวัตกรรมบทที่ 4</h2>
            ...
            <div style="margin-top: 30px;">
                <a href="#code-gallery" class="btn" style="width:100%;">เลื่อนไปดูรหัสคำสั่ง 4 ทั้งหมด</a>
            </div>
        </div>
    </div>
    ...
    <div id="code-gallery" style="margin-top: 80px;">
        ...
        <div class="accordion">
            <?php
            $ch_padded = str_pad(4, 2, '0', STR_PAD_LEFT);
    ...
    <div style="margin-top: 60px; padding: 40px; background: var(--bg-light); border: 2px dashed var(--primary); border-radius: 20px;">
        ...
        <div style="display: flex; gap: 20px;">
            ...
            <a href="module5.php" class="btn">ไปที่บทเรียนถัดไป &raquo;</a>
        </div>
    </div>
</main>
...
<script>
    ...
    document.querySelectorAll('.nav-links a').forEach(a => {
        if(a.innerText.includes('บทที่ 4')) a.classList.add('active');
    });
</script>
